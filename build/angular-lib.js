...
/***/ function(module, exports) {
	 ...
	 */
	!function (t, e) {
	  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = e() : "function" == typeof define && define.amd ? define("angular-ui-router", [], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports["angular-ui-router"] = e() : t["angular-ui-router"] = e();
	}(undefined, function () {
	  return function (t) {
	    function e(r) {
	    ...
	    }r(n(2)), r(n(46)), r(n(47)), r(n(48)), r(n(49)), r(n(50)), r(n(51)), r(n(52)), r(n(44));var i = n(26);e.UIRouter = i.UIRouter;
	  }, function (t, e, n) {
	    "use strict";
	    function r(t) {
	      for (var n in t) {
	    ...
	    function r(t, e, n, r) {
	      ...
	      void 0 === t && (t = {});for (var n = [], r = 1; r < arguments.length; r++) {
	        n[r - 1] = arguments[r];
	      }var i = o.apply(null, [{}].concat(n));return e.extend({}, i, c(t || {}, Object.keys(i)));
	    }function o(t) {
	      ...
	      void 0 === n && (n = Object.keys(t));for (var r = 0; r < n.length; r++) {
	        var i = n[r];if (t[i] != e[i]) return !1;
	      }return !0;
	    }function s(t, e) {
	      var n = {},
	          r = T(arguments, 2);for (var i in e) {
	        t(r, i) && (n[i] = e[i]);
	      }return n;
	    }function c(t) {
	      ...
	      var r = P.isArray(t) ? [] : {};return e.forEach(t, function (t, e) {
	        return r[e] = n(t, e);
	      }), r;
	    }function v(t, e) {
	      return t.push(e), t;
	      ...
	      return void 0 === e && (e = "assert failure"), function (n) {
	        if (!t(n)) throw new Error(P.isFunction(e) ? e(n) : e);return !0;
	      };
	    }function g() {
	      for (var t = [], e = 0; e < arguments.length; e++) {
	        t[e - 0] = arguments[e];
	      }if (0 === t.length) return [];var n = t.reduce(function (t, e) {
	        return Math.min(e.length, t);
	      }, 9007199254740991);return Array.apply(null, Array(n)).map(function (e, n) {
	        return t.map(function (t) {
	          return t[n];
	        });
	      });
	    }function y(t, e) {
	      var n, r;if (P.isArray(e) && (n = e[0], r = e[1]), !P.isString(n)) throw new Error("invalid parameters to applyPairs");return t[n] = r, t;
	    }function w(t) {
	      ...
	      return t.length !== e.length ? !1 : g(t, e).reduce(function (t, e) {
	        ...
	        O = _.angular || {};e.fromJson = O.fromJson || JSON.parse.bind(JSON), e.toJson = O.toJson || JSON.stringify.bind(JSON), e.copy = O.copy || b, e.forEach = O.forEach || $, e.extend = O.extend || R, e.equals = O.equals || E, e.identity = function (t) {
	      return t;
	    }, e.noop = function () {}, e.abstractKey = "abstract", e.bindFunctions = r, e.inherit = function (t, n) {
	      return e.extend(new (e.extend(function () {}, { prototype: t }))(), n);
	    ...
	    var n = function n(t) {
	      return function () {
	        ...
	        r = { $q: void 0, $injector: void 0, location: {}, locationConfig: {}, template: {} };e.services = r, ["replace", "url", "path", "search", "hash", "onChange"].forEach(function (t) {
	    ...
	    var n = function () {
	      function t(t) {
	        ...
	        for (var e = t.split("."), n = 0, r = this.glob.length; r > n; n++) {
	          "*" === this.glob[n] && (e[n] = "*");
	    ...
	    function r(t, e) {
	      ...
	      var e = u(t),
	          n = e.match(/^(function [^ ]+\([^)]*\))/);return n ? n[1] : e;
	    }function u(t) {
	      ...
	      function e(t) {
	        ...
	        p = n(5),
	        h = n(11),
	        d = n(19);e.maxLength = r, e.padString = i, e.kebobString = o, e.functionToString = a, e.fnToString = u;var v = null,
	        m = function m(t) {
	      ...
	      function t(t, e, n) {
	        ...
	        var t = function t(_t) {
	          return _t && _t.toString !== Object.prototype.toString ? _t.toString() : i.stringify(_t);
	            ...
	            e = this.type,
	            n = this.message,
	            r = t(this.detail);return "TransitionRejection(type: " + e + ", message: " + n + ", detail: " + r + ")";
	        ...
	        var r = "The transition has been superseded by a different transition (see detail).",
	            i = new t(o.SUPERSEDED, r, e);return n && n.redirected && (i.redirected = !0), i;
	      }, t.redirected = function (e) {
	        return t.superseded(e, { redirected: !0 });
	      }, t.invalid = function (e) {
	        var n = "This transition is invalid (see detail)";return new t(o.INVALID, n, e);
	      }, t.ignored = function (e) {
	        var n = "The transition was ignored.";return new t(o.IGNORED, n, e);
	      }, t.aborted = function (e) {
	        var n = "The transition has been aborted.";return new t(o.ABORTED, n, e);
	      }, t.errored = function (e) {
	        var n = "The transition errored.";return new t(o.ERROR, n, e);
	      }, t;
	    }();e.Rejection = a;
	  }, function (t, e, n) {
	    "use strict";
	    var r = n(12),
	        ...
	        $ = function () {
	      function t(e, n, r) {
	        var a = this;if (this._deferred = i.services.$q.defer(), this.promise = this._deferred.promise, this.treeChanges = function () {
	          return a._treeChanges;
	        }, this.isActive = function () {
	          return a === a._options.current();
	        }, this.router = r, !n.valid()) throw new Error(n.error());c.HookRegistry.mixin(new c.HookRegistry(), this), this._options = o.extend({ current: u.val(this) }, n.options()), this.$id = w++;var s = p.PathFactory.buildToPath(e, n);this._treeChanges = p.PathFactory.treeChanges(e, s, this._options.reloadState);var f = this._treeChanges.entering.map(function (t) {
	          return t.state;
	        });p.PathFactory.applyViewConfigs(r.transitionService.$view, this._treeChanges.to, f);var l = [new v.Resolvable(y.UIRouter, function () {
	          return r;
	          ...
	          return a.params();
	            ...
	            h = this._treeChanges.to[0],
	            d = new g.ResolveContext(this._treeChanges.to);d.addResolvables(l, h.state);
	        ...
	        return e instanceof t ? this.is({ to: e.$to().name, from: e.$from().name }) : !(e.to && !c.matchState(this.$to(), e.to) || e.from && !c.matchState(this.$from(), e.from));
	        ...
	        var e = this.treeChanges().to;return t && (e = p.PathFactory.subPath(e, function (e) {
	        ...
	        var e = new g.ResolveContext(this._treeChanges.to),
	            n = function n(t) {
	          var n = e.getResolvable(t);if (void 0 === n) throw new Error("Dependency Injection token not found: ${stringify(token)}");return n.data;
	        };return a.isArray(t) ? t.map(n) : n(t);
	      }, t.prototype.addResolvable = function (t, e) {
	        void 0 === e && (e = "");var n = "string" == typeof e ? e : e.name,
	            r = this._treeChanges.to,
	            i = o.find(r, function (t) {
	          return t.state.name === n;
	        }),
	            a = new g.ResolveContext(r);a.addResolvables([t], i.state);
	        ...
	        void 0 === t && (t = "entering");var n = this._treeChanges[t];return n = e ? n.filter(u.propEq("state", e)) : n, n.map(u.prop("views")).filter(o.identity).reduce(o.unnestR, []);
	      }, t.prototype.redirect = function (t) {
	        var e = o.extend({}, this.options(), t.options(), { previous: this });t = new h.TargetState(t.identifier(), t.$state(), t.params(), e);var n = this.router.transitionService.create(this._treeChanges.from, t),
	            r = this.treeChanges().entering,
	            i = n.treeChanges().entering,
	            a = function a(t) {
	          return function (e) {
	            return t && e.state.includes[t.name];
	          };
	        },
	            s = l.PathNode.matching(i, r).filter(u.not(a(t.options().reloadState)));return s.forEach(function (t, e) {
	          t.resolvables = r[e].resolvables;
	        }), n;
	      }, t.prototype._changedParams = function () {
	        var t = this._treeChanges,
	            e = t.to,
	            n = t.from;if (!this._options.reload && o.tail(e).state === o.tail(n).state) {
	          var r = e.map(function (t) {
	            ...
	            return t.map(function (t) {
	              ...
	              a = i[0],
	              u = i[1],
	              s = o.arrayTuples(r, a, u);return s.map(function (t) {
	            var e = t[0],
	                n = t[1],
	        ...
	        var t = this._changedParams();return t ? 0 === t.length : !1;
	      }, t.prototype.hookBuilder = function () {
	        return new f.HookBuilder(this.router.transitionService, this, { transition: this, current: this._options.current });
	      }, t.prototype.run = function () {
	        var t = this,
	            e = s.TransitionHook.runSynchronousHooks,
	            n = this.hookBuilder(),
	            i = this.router.globals;i.transitionHistory.enqueue(this);var o = e(n.getOnBeforeHooks());if (m.Rejection.isTransitionRejectionPromise(o)) {
	          o["catch"](function () {
	            return 0;
	        ...
	        }if (this.ignored()) return r.trace.traceTransitionIgnored(this), this._deferred.reject(m.Rejection.ignored()), this.promise;var c = function c() {
	        ...
	        };r.trace.traceTransitionStart(this);var l = function l(t, e) {
	        ...
	        var t = this.$to();return t.self[o.abstractKey] ? "Cannot transition to abstract state '" + t.name + "'" : d.Param.validates(t.parameters(), this.params()) ? void 0 : "Param values not valid for state '" + t.name + "'";
	        ...
	        var t = this.from(),
	          ...
	          return null !== t["#"] && void 0 !== t["#"] ? t : o.omit(t, "#");
	            ...
	            r = this.$id,
	            i = a.isObject(t) ? t.name : t,
	            s = o.toJson(n(this._treeChanges.from.map(u.prop("paramValues")).reduce(o.mergeR, {}))),
	            c = this.valid() ? "" : "(X) ",
	            f = a.isObject(e) ? e.name : e,
	            l = o.toJson(n(this.params()));return "Transition#" + r + "( '" + i + "'" + s + " -> " + c + "'" + f + "'" + l + " )";
	      }, t.diToken = t, t;
	    }();e.Transition = $;
	  }, function (t, e, n) {
	    "use strict";
	    function r(t) {
	      ...
	      function t() {
	        ...
	        var n = this;e.length || (e = Object.keys(c).filter(function (t) {
	        ...
	        if (this.enabled(c.TRANSITION)) {
	          var e = t.$id,
	              ...
	              r = u.stringify(t);console.log("Transition #" + e + " Digest #" + n + ": Started  -> " + r);
	        }
	      }, t.prototype.traceTransitionIgnored = function (t) {
	        if (this.enabled(c.TRANSITION)) {
	          var e = t && t.$id,
	              n = this.approximateDigests,
	              r = u.stringify(t);console.log("Transition #" + e + " Digest #" + n + ": Ignored  <> " + r);
	        }
	      }, t.prototype.traceHookInvocation = function (t, e) {
	        if (this.enabled(c.HOOK)) {
	          var n = o.parse("transition.$id")(e),
	              ...
	              s = u.functionToString(t.fn);console.log("Transition #" + n + " Digest #" + r + ":   Hook -> " + i + " context: " + a + ", " + u.maxLength(200, s));
	        }
	      }, t.prototype.traceHookResult = function (t, e, n) {
	        if (this.enabled(c.HOOK)) {
	          var r = o.parse("transition.$id")(n),
	              i = this.approximateDigests,
	              a = u.stringify(t),
	              s = u.stringify(e);console.log("Transition #" + r + " Digest #" + i + ":   <- Hook returned: " + u.maxLength(200, a) + ", transition result: " + u.maxLength(200, s));
	        }
	      }, t.prototype.traceResolvePath = function (t, e, n) {
	        if (this.enabled(c.RESOLVE)) {
	          var r = n && n.$id,
	              i = this.approximateDigests,
	              o = t && t.toString();console.log("Transition #" + r + " Digest #" + i + ":         Resolving " + o + " (" + e + ")");
	        }
	        ...
	        if (this.enabled(c.RESOLVE)) {
	          var n = e && e.$id,
	              r = this.approximateDigests,
	              i = t && t.toString(),
	              o = u.stringify(t.data);console.log("Transition #" + n + " Digest #" + r + ":               <- Resolved  " + i + " to: " + u.maxLength(200, o));
	        }
	      }, t.prototype.traceError = function (t, e) {
	        if (this.enabled(c.TRANSITION)) {
	          var n = e && e.$id,
	              r = this.approximateDigests,
	              i = u.stringify(e);console.log("Transition #" + n + " Digest #" + r + ": <- Rejected " + i + ", reason: " + t);
	        }
	        ...
	        if (this.enabled(c.TRANSITION)) {
	          var n = e && e.$id,
	              r = this.approximateDigests,
	              i = t.name,
	              o = u.stringify(e);console.log("Transition #" + n + " Digest #" + r + ": <- Success  " + o + ", final state: " + i);
	        }
	    ...
	    var r = n(3),
	        ...
	        c = n(10),
	        f = n(14),
	        l = { async: !0, rejectIfSuperseded: !0, current: r.noop, transition: null, traceData: {}, bind: null },
	        p = function () {
	      function t(t, e, n, i, o) {
	        var a = this;this.transition = t, this.stateContext = e, this.hookFn = n, this.resolveContext = i, this.options = o, this.isSuperseded = function () {
	          return a.options.current() !== a.options.transition;
	        }, this.options = r.defaults(o, l);
	      }return t.prototype.invokeHook = function () {
	        var t = this,
	            e = t.options,
	            n = t.hookFn;t.resolveContext;if (u.trace.traceHookInvocation(this, e), e.rejectIfSuperseded && this.isSuperseded()) return c.Rejection.superseded(e.current()).toPromise();var r = n.call(e.bind, this.transition, this.stateContext);return this.handleHookResult(r);
	        ...
	        var e = this;if (o.isDefined(t)) {
	          var n = a.pattern([[this.isSuperseded, function () {
	            ...
	            return t.then(e.handleHookResult.bind(e));
	              ...
	              r = n(t);return r && u.trace.traceHookResult(t, r, this.options), r;
	        }
	      }, t.prototype.toString = function () {
	        var t = this,
	            e = t.options,
	            n = t.hookFn,
	            r = a.parse("traceData.hookType")(e) || "internal",
	            o = a.parse("traceData.context.state.name")(e) || a.parse("traceData.context")(e) || "unknown",
	            u = i.fnToString(n);return r + " context: " + o + ", " + i.maxLength(200, u);
	      }, t.runSynchronousHooks = function (t, e) {
	        void 0 === e && (e = !1);for (var n = [], r = 0; r < t.length; r++) {
	          try {
	            n.push(t[r].invokeHook());
	          } catch (i) {
	            if (!e) return c.Rejection.errored(i).toPromise();console.error("Swallowed exception during synchronous hook handler: " + i);
	          }
	        }var u = n.filter(c.Rejection.isTransitionRejectionPromise);return u.length ? u[0] : n.filter(o.isPromise).reduce(function (t, e) {
	    ...
	    function r(t, e) {
	      function n(t) {
	        for (var e = r, n = 0; n < e.length; n++) {
	          var i = u.Glob.fromString(e[n]);if (i && i.matches(t.name) || !i && e[n] === t.name) return !0;
	        }return !1;
	      }var r = a.isString(e) ? [e] : e,
	          i = a.isFunction(r) ? r : n;return !!i(t);
	    }function i(t, e) {
	      return function (n, r, i) {
	        void 0 === i && (i = {});var a = new s(n, r, i);return t[e].push(a), function () {
	          o.removeFrom(t[e])(a);
	        };
	      };
	    }var o = n(3),
	        a = n(4),
	        u = n(7);e.matchState = r;var s = function () {
	      function t(t, e, n) {
	        void 0 === n && (n = {}), this.callback = e, this.matchCriteria = o.extend({ to: !0, from: !0, exiting: !0, retained: !0, entering: !0 }, t), this.priority = n.priority || 0, this.bind = n.bind || null;
	      }return t._matchingNodes = function (t, e) {
	        if (e === !0) return t;var n = t.filter(function (t) {
	          return r(t.state, e);
	        });return n.length ? n : null;
	      }, t.prototype.matches = function (e) {
	        var n = this.matchCriteria,
	            r = t._matchingNodes,
	            i = { to: r([o.tail(e.to)], n.to), from: r([o.tail(e.from)], n.from), exiting: r(e.exiting, n.exiting), retained: r(e.retained, n.retained), entering: r(e.entering, n.entering) },
	    ...
	    function r(t) {
	      return void 0 === t && (t = !1), function (e, n) {
	        ...
	        s = function () {
	      function t(t, e, n) {
	        var o = this;this.$transitions = t, this.transition = e, this.baseHookOptions = n, this.getOnBeforeHooks = function () {
	        ...
	        var t = this.getOnStartHooks(),
	            ...
	            n = this.getOnRetainHooks(),
	            r = this.getOnEnterHooks(),
	            o = this.getOnFinishHooks(),
	            a = [t, e, n, r, o];return a.reduce(i.unnestR, []).filter(i.identity);
	      }, t.prototype._buildNodeHooks = function (t, e, n, r) {
	        var o = this,
	            s = this._matchingHooks(t, this.treeChanges);if (!s) return [];var c = function c(n) {
	          var s = n.matches(o.treeChanges),
	              c = s[e],
	              f = "exiting" === e ? o.treeChanges.from : o.treeChanges.to,
	              l = new u.ResolveContext(f);return c.map(function (e) {
	            var u = i.extend({ bind: n.bind, traceData: { hookType: t, context: e } }, o.baseHookOptions, r),
	                s = u.stateHook ? e.state : null,
	                c = l.subContext(e.state),
	                f = new a.TransitionHook(o.transition, s, n.callback, c, u);return { hook: n, node: e, transitionHook: f };
	          });
	    ...
	    var r = n(3),
	      ...
	      function t(t) {
	        ...
	        var n = this;void 0 === t && (t = "LAZY");var i = r.inArray(p, t) ? t : "LAZY",
	        ...
	        var e = this.findNode(t),
	            n = c.PathFactory.subPath(this._path, function (t) {
	          return t === e;
	        }) || this._path,
	          ...
	          var e = i.filter(function (e) {
	            return e.token === t;
	          });if (e.length) return r.tail(e);var n = a.services.$injector.get(t);if (!n) throw new Error("Could not find Dependency Injection token: " + f.stringify(t));return new s.Resolvable(t, function () {
	            return n;
	          }, [], n);
	        };return t.deps.map(o);
	      }, t;
	      ...
	      function t(e, n, o, a, s) {
	        ...
	        var n = this,
	          ...
	          return n.resolveFn.apply(null, t);
	            ...
	            s = function s(t) {
	          var e = t.cache();return e.toPromise().then(function () {
	            return e;
	          });
	        },
	            c = t.findNode(this),
	            f = c && c.state,
	            l = "RXWAIT" === this.getPolicy(f).async ? s : function (t) {
	          return t;
	        },
	            p = function p(t) {
	      ...
	      function t() {}return t.makeTargetState = function (t) {
	        ...
	        function o(t, e) {
	          ...
	          var i = r.extend({}, e && e.paramValues),
	              u = r.pick(i, n);i = r.omit(i, n);var s = o(t, e.state) || {},
	              c = r.extend(i, s, u);return new a.PathNode(e.state).applyRawParams(c);
	        }return void 0 === n && (n = []), e.map(u);
	      }, t.treeChanges = function (t, e, n) {
	        function r(t, n) {
	          var r = a.PathNode.clone(t);return r.paramValues = e[n].paramValues, r;
	        }for (var o = 0, u = Math.min(t.length, e.length), s = function s(t) {
	          return t.parameters({ inherit: !1 }).filter(i.not(i.prop("dynamic"))).map(i.prop("id"));
	        }, c = function c(t, e) {
	          return t.equals(e, s(t.state));
	        }; u > o && t[o].state !== n && c(t[o], e[o]);) {
	          o++;
	        }var f, l, p, h, d;f = t, l = f.slice(0, o), p = f.slice(o);var v = l.map(r);return h = e.slice(o), d = v.concat(h), { from: f, to: d, retained: l, exiting: p, entering: h };
	    ...
	    var r = n(3),
	      ...
	      function t(e) {
	        ...
	        var n = this;void 0 === e && (e = this.paramSchema.map(i.prop("id")));var o = function o(e) {
	        ...
	        for (var n = [], r = 0; r < t.length && r < e.length; r++) {
	          var i = t[r],
	              a = e[r];if (i.state !== a.state) break;if (!o.Param.equals(i.paramSchema, i.paramValues, a.paramValues)) break;n.push(i);
	        }return n;
	      }, t;
	    }();e.PathNode = a;
	  }, function (t, e, n) {
	    "use strict";
	    function r(t) {
	      return t = v(t) && { value: t } || t, u.extend(t, { $$fn: c.isInjectable(t.value) ? t.value : function () {
	          return t.value;
	        } });
	    }function i(t, e, n, r) {
	      if (t.type && e && "string" !== e.name) throw new Error("Param '" + r + "' has two type configurations.");return t.type && e && "string" === e.name && h.paramTypes.type(t.type) ? h.paramTypes.type(t.type) : e ? e : t.type ? t.type instanceof p.ParamType ? t.type : h.paramTypes.type(t.type) : n === m.CONFIG ? h.paramTypes.type("any") : h.paramTypes.type("string");
	    }function o(t, e) {
	      var n = t.squash;if (!e || n === !1) return !1;if (!c.isDefined(n) || null == n) return l.matcherConfig.defaultSquashPolicy();if (n === !0 || c.isString(n)) return n;throw new Error("Invalid squash policy: '" + n + "'. Valid policies: false, true, or arbitrary string");
	    }function a(t, e, n, r) {
	      var i,
	          o,
	          a = [{ from: "", to: n || e ? void 0 : "" }, { from: null, to: n || e ? void 0 : "" }];return i = c.isArray(t.replace) ? t.replace : [], c.isString(r) && i.push({ from: r, to: void 0 }), o = u.map(i, s.prop("from")), u.filter(a, function (t) {
	    ...
	    }(e.DefType || (e.DefType = {}));var m = e.DefType,
	        g = function () {
	      function t(t, e, n, s) {
	        function f() {
	          var e = { array: s === m.SEARCH ? "auto" : !1 },
	              r = t.match(/\[\]$/) ? { array: !0 } : {};return u.extend(e, r, n).array;
	        }n = r(n), e = i(n, e, s, t);var l = f();e = l ? e.$asArray(l, s === m.SEARCH) : e;var p = void 0 !== n.value,
	            h = c.isDefined(n.dynamic) ? !!n.dynamic : !!e.dynamic,
	            d = o(n, p),
	            v = a(n, l, p, d);u.extend(this, { id: t, type: e, location: s, squash: d, replace: v, isOptional: p, dynamic: h, config: n, array: l });
	        ...
	        var e = this,
	          ...
	          if (!f.services.$injector) throw new Error("Injectable functions cannot be called at configuration time");var t = f.services.$injector.invoke(e.config.$$fn);if (null !== t && void 0 !== t && !e.type.is(t)) throw new Error("Default value (" + t + ") for parameter '" + e.id + "' is not an instance of ParamType (" + e.type.name + ")");return t;
	            ...
	            r = function r(t) {
	          var n = u.map(u.filter(e.replace, s.propEq("from", t)), s.prop("to"));return n.length ? n[0] : t;
	        ...
	        if ((!c.isDefined(t) || null === t) && this.isOptional) return !0;var e = this.type.$normalize(t);if (!this.type.is(e)) return !1;var n = this.type.encode(e);return !(c.isString(n) && !this.type.pattern.exec(n));
	      }, t.prototype.toString = function () {
	    ...
	    var r = n(4),
	      ...
	      function t() {
	        ...
	        if (r.isDefined(t) && t !== !0 && t !== !1 && !r.isString(t)) throw new Error("Invalid squash policy: " + t + ". Valid policies: false, true, arbitrary-string");return this._defaultSquashPolicy = r.isDefined(t) ? t : this._defaultSquashPolicy;
	      }, t;
	    ...
	    function r(t, e) {
	      function n(t) {
	        ...
	        return function (a) {
	          if (o.isArray(a) && 0 === a.length) return a;var u = n(a),
	      ...
	      }var s = this;["encode", "decode", "equals", "$normalize"].map(function (e) {
	    ...
	    function r(t) {
	      ...
	      return null != t ? t.toString().replace(/~2F/g, "/").replace(/~~/g, "~") : t;
	        ...
	        f = function () {
	      function t() {
	        this.enqueue = !0, this.typeQueue = [], this.defaultTypes = { hash: { encode: r, decode: i, is: u.is(String), pattern: /.*/, equals: function equals(t, e) {
	              return t == e;
	            } }, string: { encode: r, decode: i, is: u.is(String), pattern: /[^\/]*/ }, "int": { encode: r, decode: function decode(t) {
	            ...
	            }, is: u.is(Boolean), pattern: /0|1/ }, date: { encode: function encode(t) {
	            ...
	            }, pattern: /[0-9]{4}-(?:0[1-9]|1[0-2])-(?:0[1-9]|[1-2][0-9]|3[0-1])/, capture: /([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])/ }, json: { encode: o.toJson, decode: o.fromJson, is: u.is(Object), equals: o.equals, pattern: /[^\/]*/ }, any: { encode: o.identity, decode: o.identity, equals: o.equals, pattern: /.*/ } };var t = function t(_t2, e) {
	        ...
	        if (!a.isDefined(e)) return this.types[t];if (this.types.hasOwnProperty(t)) throw new Error("A type named '" + t + "' has already been defined.");return this.types[t] = new c.ParamType(o.extend({ name: t }, e)), n && (this.typeQueue.push({ name: t, def: n }), this.enqueue || this._flushTypeQueue()), this;
	    ...
	    function r() {
	      ...
	      function t() {
	        ...
	        if (!o.isObject(t)) return !1;var e = !0;return i.forEach(a.UrlMatcher.prototype, function (n, r) {
	          o.isFunction(n) && (e = e && o.isDefined(t[r]) && o.isFunction(t[r]));
	        }), e;
	      }, t.prototype.type = function (t, e, n) {
	        var r = c.paramTypes.type(t, e, n);return o.isDefined(e) ? this : r;
	    ...
	    function r(t, e) {
	      ...
	      return t[e] = t[e] || n();
	        ...
	        d = function () {
	      function t(e, n) {
	        var a = this;this.config = n, this._cache = { path: [], pattern: null }, this._children = [], this._params = [], this._segments = [], this._compiled = [], this.pattern = e, this.config = i.defaults(this.config, { params: {}, strict: !0, caseInsensitive: !1, paramMap: i.identity });for (var c, f, l, p = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, h = /([:]?)([\w\[\].-]+)|\{([\w\[\].-]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, d = 0, v = [], m = function m(n) {
	          if (!t.nameValidator.test(n)) throw new Error("Invalid parameter name '" + n + "' in pattern '" + e + "'");if (i.find(a._params, o.propEq("id", n))) throw new Error("Duplicate parameter name '" + n + "' in pattern '" + e + "'");
	        }, g = function g(t, n) {
	          var r = t[2] || t[3],
	              o = n ? t[4] : t[4] || ("*" === t[1] ? ".*" : null);return { id: r, regexp: o, cfg: a.config.params[r], segment: e.substring(d, t.index), type: o ? s.paramTypes.type(o || "string") || i.inherit(s.paramTypes.type("string"), { pattern: new RegExp(o, a.config.caseInsensitive ? "i" : void 0) }) : null };
	        }; (c = p.exec(e)) && (f = g(c, !1), !(f.segment.indexOf("?") >= 0));) {
	          m(f.id), this._params.push(u.Param.fromPath(f.id, f.type, this.config.paramMap(f.cfg, !1))), this._segments.push(f.segment), v.push([f.segment, i.tail(this._params)]), d = p.lastIndex;
	        }l = e.substring(d);var y = l.indexOf("?");if (y >= 0) {
	          var w = l.substring(y);if (l = l.substring(0, y), w.length > 0) for (d = 0; c = h.exec(w);) {
	            f = g(c, !0), m(f.id), this._params.push(u.Param.fromSearch(f.id, f.type, this.config.paramMap(f.cfg, !0))), d = p.lastIndex;
	          }
	        }this._segments.push(l), i.extend(this, { _compiled: v.map(function (t) {
	            return r.apply(null, t);
	          }).concat(r(l)), prefix: this._segments[0] }), Object.freeze(this);
	        ...
	        function a(t) {
	        ...
	        }var u = this;void 0 === e && (e = {}), void 0 === r && (r = {});var s = h(this._cache, "pattern", function () {
	        ...
	        }).exec(t);if (!s) return null;var f = this.parameters(),
	          ...
	          return t + e;
	            ...
	            v = {};if (d !== s.length - 1) throw new Error("Unbalanced capture group in route '" + this.pattern + "'");for (var m = 0; d > m; m++) {
	          for (var g = l[m], y = s[m + 1], w = 0; w < g.replace.length; w++) {
	        ...
	        void 0 === e && (e = {});var n = i.tail(this._cache.path);return i.find(this._params, o.propEq("id", t)) || e.inherit !== !1 && n && n.parameter(t) || null;
	      }, t.prototype.validates = function (t) {
	        var e = this,
	            n = function n(t, e) {
	          ...
	          var r = t[0],
	              i = t[1];return n(e.parameter(r), i);
	        }).reduce(i.allTrueR, !0);
	        ...
	        function n(t) {
	          var n = t.value(e[t.id]),
	              ...
	              i = r ? t.squash : !1,
	              o = t.type.encode(n);return { param: t, value: n, isDefaultValue: r, squash: i, encoded: o };
	        }if (void 0 === e && (e = {}), !this.validates(e)) return null;var r = this._cache.path.slice().concat(this),
	            o = r.map(t.pathSegmentsAndParams).reduce(l.unnestR, []),
	            u = r.map(t.queryParams).reduce(l.unnestR, []),
	            s = o.reduce(function (e, r) {
	          if (a.isString(r)) return e + r;var o = n(r),
	              u = o.squash,
	              s = o.encoded,
	          ...
	          var e = n(t),
	              r = e.squash,
	              o = e.encoded,
	              u = e.isDefaultValue;if (!(null == o || u && r !== !1) && (a.isArray(o) || (o = [o]), 0 !== o.length)) return t.type.raw || (o = i.map(o, encodeURIComponent)), o.map(function (e) {
	            return t.id + "=" + e;
	          });
	        }).filter(i.identity).reduce(l.unnestR, []).join("&");return s + (c ? "?" + c : "") + (e["#"] ? "#" + e["#"] : "");
	    ...
	    function r(t) {
	      ...
	      if (!r) return !1;var i = t.invoke(n, n, { $match: r, $stateParams: e });return c.isDefined(i) ? i : !0;
	    }function a(t, e, n) {
	      var r = f.services.locationConfig.baseHref();return "/" === r ? t : e ? r.slice(0, -1) + t : n ? r.slice(1) + t : t;
	    }function u(t, e, n) {
	      function r(t) {
	        var e = t(f.services.$injector, l);return e ? (c.isString(e) && (l.replace(), l.url(e)), !0) : !1;
	      }if (!n || !n.defaultPrevented) {
	        var i,
	            o = t.length;for (i = 0; o > i; i++) {
	          if (r(t[i])) return;
	        }e && r(e);
	      }
	    }var s = n(3),
	      ...
	      function t(t, e) {
	        ...
	        var n,
	            a = this,
	            u = a.$urlMatcherFactory,
	            p = a.$stateParams,
	            h = c.isString(e);if (c.isString(t) && (t = u.compile(t)), !h && !c.isFunction(e) && !c.isArray(e)) throw new Error("invalid 'handler' in when()");var d = { matcher: function matcher(t, e) {
	            ...
	            if (t.global || t.sticky) throw new Error("when() RegExp must not be global or sticky");return h && (n = e, e = ["$match", function (t) {
	              return i(n, t);
	            }]), s.extend(function () {
	              return o(f.services.$injector, p, e, t.exec(l.path()));
	            }, { prefix: r(t) });
	          } },
	            v = { matcher: u.isMatcher(t), regex: t instanceof RegExp };for (var m in v) {
	          if (v[m]) return this.rule(d[m](t, e));
	      ...
	      function t(e) {
	        ...
	        if (!t.validates(e)) return null;var r = t.format(e);n = n || { absolute: !1 };var i = f.services.locationConfig,
	            o = i.html5Mode();if (o || null === r || (r = "#" + i.hashPrefix() + r), r = a(r, o, n.absolute), !n.absolute || !r) return r;var u = !o && r ? "/" : "",
	            s = i.port();return s = 80 === s || 443 === s ? "" : ":" + s, [i.protocol(), "://", i.host(), s, u, r].join("");
	      }, t;
	    }();e.UrlRouter = h;
	  }, function (t, e, n) {
	    "use strict";
	    ...
	    var r = n(11),
	        ...
	        s = n(35),
	        c = n(36),
	        f = n(5);e.defaultTransOpts = { location: !0, relative: null, inherit: !1, notify: !0, reload: !1, custom: {}, current: function current() {
	        return null;
	      } };var l = function () {
	      function t(t) {
	        ...
	        var t = this._deregisterHookFns;t.redirectTo = this.onStart({ to: function to(t) {
	            return !!t.redirectTo;
	          } }, s.redirectToHook), t.onExit = this.onExit({ exiting: function exiting(t) {
	            return !!t.onExit;
	          } }, c.onExitHook), t.onRetain = this.onRetain({ retained: function retained(t) {
	            return !!t.onRetain;
	          } }, c.onRetainHook), t.onEnter = this.onEnter({ entering: function entering(t) {
	            return !!t.onEnter;
	    ...
	    "use strict";
	    var r = n(3),
	        i = n(17);e.eagerResolvePath = function (t) {
	    ...
	    "use strict";
	    function r(t) {
	      var e = t.views("entering");if (e.length) return a.services.$q.all(e.map(function (t) {
	        return t.load();
	      })).then(o.noop);
	    }function i(t) {
	      var e = t.views("entering"),
	        ...
	        a = n(6);e.loadEnteringViews = r, e.activateViews = i;
	  }, function (t, e) {
	    "use strict";
	    function n(t) {
	      var e = t.options(),
	          n = t.router.stateService,
	          r = t.router.urlRouter;if (e.location && n.$current.navigable) {
	    ...
	    var r = n(4),
	        i = n(6),
	        o = n(14);e.redirectToHook = function (t) {
	      function e(e) {
	        var n = t.router.stateService;return e instanceof o.TargetState ? e : r.isString(e) ? n.target(e, t.params(), t.options()) : e.state || e.params ? n.target(e.state || t.to(), e.params || t.params(), t.options()) : void 0;
	      }var n = t.to().redirectTo;if (n) return r.isFunction(n) ? i.services.$q.when(n(t)).then(e) : e(n);
	    };
	  }, function (t, e) {
	    "use strict";
	    function n(t) {
	    ...
	    var r = n(3),
	      ...
	      function t() {
	        var t = this;this.uiViews = [], this.viewConfigs = [], this._viewConfigFactories = {}, this.sync = function () {
	          function e(t) {
	            ...
	            return [t.fqn, t];
	              ...
	              a = function a(t) {
	            return function (e) {
	              if (t.$type !== e.viewDecl.$type) return !1;var n = e.viewDecl,
	                  i = n.$uiViewName.split("."),
	                  a = t.fqn.split(".");if (!r.equals(i, a.slice(0 - i.length))) return !1;var u = 1 - i.length || void 0,
	                  s = a.slice(0, u).join("."),
	                  c = o[s].creationContext;return n.$uiViewContextAnchor === (c && c.name);
	            };
	          },
	            ...
	            return e * (t(n) - t(r));
	              ...
	              s = function s(e) {
	            var r = t.viewConfigs.filter(a(e));return r.length > 1 && r.sort(u(n, -1)), [e, r[0]];
	          },
	              c = function c(e) {
	            var n = e[0],
	                r = e[1];-1 !== t.uiViews.indexOf(n) && n.configUpdated(r);
	        ...
	        a.trace.traceViewServiceUIViewEvent("-> Registering", t);var e = this.uiViews,
	          ...
	          var n = e.indexOf(t);return 0 >= n ? void a.trace.traceViewServiceUIViewEvent("Tried removing non-registered uiView", t) : (a.trace.traceViewServiceUIViewEvent("<- Deregistering", t), void r.removeFrom(e)(t));
	        };
	        ...
	        void 0 === e && (e = "");var n = e.split("@"),
	            ...
	            a = /^(\^(?:\.\^)*)\.(.*$)/.exec(r);a && (i = a[1], r = a[2]), "!" === r.charAt(0) && (r = r.substr(1), i = "");var u = /^(\^(?:\.\^)*)$/;if (u.exec(i)) {
	    ...
	    var r = n(39),
	        ...
	        a = function () {
	      function t(t, e) {
	        this.states = {}, this.matcher = new r.StateMatcher(this.states), this.builder = new i.StateBuilder(this.matcher, t), this.stateQueue = new o.StateQueueManager(this.states, this.builder, e);var n = { name: "", url: "^", views: null, params: { "#": { value: null, type: "hash", dynamic: !0 } }, "abstract": !0 },
	            a = this._root = this.stateQueue.register(n);a.navigable = null;
	    ...
	    var r = n(4),
	      ...
	      function t(t) {
	        ...
	        if (t || "" === t) {
	          var n = r.isString(t),
	              i = n ? t : t.name;this.isRelative(i) && (i = this.resolvePath(i, e));var o = this._states[i];return !o || !n && (n || o !== t && o.self !== t) ? void 0 : o;
	        }
	      }, t.prototype.resolvePath = function (t, e) {
	        if (!e) throw new Error("No reference point given for path '" + t + "'");for (var n = this.find(e), r = t.split("."), i = 0, o = r.length, a = n; o > i; i++) {
	          if ("" !== r[i] || 0 !== i) {
	            if ("^" !== r[i]) break;if (!a.parent) throw new Error("Path '" + t + "' not valid for state '" + n.name + "'");a = a.parent;
	          } else a = n;
	        }var u = r.slice(i).join(".");return a.name + (a.name && u ? "." : "") + u;
	      }, t;
	    }();e.StateMatcher = i;
	  }, function (t, e, n) {
	    "use strict";
	    function r(t) {
	      ...
	      var e = function e(t, _e2) {
	        return h.Param.fromConfig(_e2, null, t);
	      },
	          n = t.url && t.url.parameters({ inherit: !1 }) || [],
	          r = c.values(c.map(c.omit(t.params || {}, n.map(p.prop("id"))), e));
	      ...
	      var e = function e(t) {
	        ...
	        throw new Error("Invalid resolve value: " + l.stringify(t));
	          ...
	          m = t.resolve,
	          g = f.isArray(m) ? m : e(m);return g.map(h);
	    }var c = n(3),
	        f = n(4),
	        l = n(9),
	        p = n(5),
	    ...
	    };e.resolvablesBuilder = s;var w = function () {
	      function t(t, e) {
	        function n(e) {
	          ...
	          return t.find("");
	            ...
	            l = function l(t) {
	          return "" === t.name;
	        };this.builders = { self: [r], parent: [n], data: [i], url: [g(e, f)], navigable: [y(l)], params: [o], views: [], path: [a], includes: [u], resolvables: [s] };
	      }return t.prototype.builder = function (t, e) {
	        var n = this.builders,
	            r = n[t] || [];return f.isString(t) && !f.isDefined(e) ? r.length > 1 ? r : r[0] : f.isString(t) && f.isFunction(e) ? (n[t] = r, n[t].push(e), function () {
	        ...
	        var e = this,
	            n = e.matcher,
	            r = e.builders,
	            i = this.parentName(t);if (i && !n.find(i)) return null;for (var o in r) {
	        ...
	        var e = t.name || "";return -1 !== e.indexOf(".") ? e.substring(0, e.lastIndexOf(".")) : t.parent ? f.isString(t.parent) ? t.parent : t.parent.name : "";
	      }, t.prototype.name = function (t) {
	        var e = t.name;if (-1 !== e.indexOf(".") || !t.parent) return e;var n = f.isString(t.parent) ? t.parent : t.parent.name;return n ? n + "." + e : e;
	      }, t;
	    }();e.StateBuilder = w;
	  }, function (t, e, n) {
	    "use strict";
	    var r = n(3),
	      ...
	      function t(t, e, n) {
	        ...
	        var e = this,
	            ...
	            a = e.queue,
	            u = e.$state,
	            s = r.inherit(new o.State(), r.extend({}, t, { self: t, resolve: t.resolve || [], toString: function toString() {
	            return t.name;
	          } }));if (!i.isString(s.name)) throw new Error("State must have a valid name");if (n.hasOwnProperty(s.name) || -1 !== r.pluck(a, "name").indexOf(s.name)) throw new Error("State '" + s.name + "' is already defined");return a.push(s), this.$state && this.flush(u), s;
	      }, t.prototype.flush = function (t) {
	        for (var e, n, r, i = this, o = i.queue, a = i.states, u = i.builder, s = [], c = {}; o.length > 0;) {
	          if (n = o.shift(), e = u.build(n), r = s.indexOf(n), e) {
	            if (a.hasOwnProperty(n.name)) throw new Error("State '" + name + "' is already defined");a[n.name] = n, this.attachRoute(t, n), r >= 0 && s.splice(r, 1);
	          } else {
	            var f = c[n.name];if (c[n.name] = o.length, r >= 0 && f === o.length) return a;0 > r && s.push(n), o.push(n);
	          }
	        }return a;
	      }, t.prototype.autoFlush = function (t) {
	        this.$state = t, this.flush(t);
	      }, t.prototype.attachRoute = function (t, e) {
	        var n = this.$urlRouterProvider;!e[r.abstractKey] && e.url && n.when(e.url, ["$match", "$stateParams", function (n, i) {
	          t.$current.navigable === e && r.equalForKeys(n, i) || t.transitionTo(e, n, { inherit: !0, location: !1 });
	        }]);
	      }, t;
	    ...
	    var r = n(3),
	      ...
	      function t(t) {
	        ...
	        t = r.defaults(t, { inherit: !0 });var e = t.inherit && this.parent && this.parent.parameters() || [];return e.concat(r.values(this.params));
	      }, t.prototype.parameter = function (t, e) {
	      ...
	      function t(e) {
	        this.router = e, this._defaultErrorHandler = function (t) {
	          t instanceof Error && t.stack ? console.error(t.stack) : t instanceof f.Rejection ? (console.error(t), t.detail && t.detail.stack && console.error(t.detail.stack)) : console.error(t);
	            ...
	            r = Object.keys(t.prototype).filter(function (t) {
	        ...
	        function n() {
	          ...
	          return i.transitionHistory.peekTail();
	            ...
	            h = new o.Queue([].concat(this.router.stateProvider.invalidCallbacks)),
	            d = a.services.$q,
	          ...
	          if (t instanceof l.TargetState) {
	            var e = t;return e = r.target(e.identifier(), e.params(), e.options()), e.valid() ? s() !== c ? f.Rejection.superseded().toPromise() : r.transitionTo(e.identifier(), e.params(), e.options()) : f.Rejection.invalid(e.error()).toPromise();
	          }
	        };return n();
	      }, t.prototype.reload = function (t) {
	        return this.transitionTo(this.current, this.params, { reload: i.isDefined(t) ? t : !0, inherit: !1, notify: !1 });
	        ...
	        if (void 0 === n && (n = {}), i.isObject(n.reload) && !n.reload.name) throw new Error("Invalid reload state object");var r = this.router.stateRegistry;if (n.reloadState = n.reload === !0 ? r.root() : r.matcher.find(n.reload, n.relative), n.reload && !n.reloadState) throw new Error("No such reload state '" + (i.isString(n.reload) ? n.reload : n.reload.name) + "'");var o = r.matcher.find(t, n.relative);return new l.TargetState(t, o, e, n);
	      }, t.prototype.transitionTo = function (t, e, n) {
	        var i = this;void 0 === e && (e = {}), void 0 === n && (n = {});var o = this.router,
	            u = o.globals,
	            p = u.transitionHistory;n = r.defaults(n, c.defaultTransOpts), n = r.extend(n, { current: p.peekTail.bind(p) });var h = this.target(t, e, n),
	            d = u.successfulTransitions.peekTail(),
	            v = function v() {
	          return [new s.PathNode(i.router.stateRegistry.root())];
	        },
	            m = d ? d.treeChanges().to : v();if (!h.exists()) return this._handleInvalidTargetState(m, h);if (!h.valid()) return r.silentRejection(h.error());var g = function g(t) {
	          return function (e) {
	            if (e instanceof f.Rejection) {
	              if (e.type === f.RejectType.IGNORED) return o.urlRouter.update(), u.current;if (e.type === f.RejectType.SUPERSEDED && e.redirected && e.detail instanceof l.TargetState) {
	                var n = t.redirect(e.detail);return n.run()["catch"](g(n));
	              }if (e.type === f.RejectType.ABORTED) return o.urlRouter.update(), a.services.$q.reject(e);
	            }var r = i.defaultErrorHandler();return r(e), a.services.$q.reject(e);
	          };
	        },
	            y = this.router.transitionService.create(m, h),
	            w = y.run()["catch"](g(y));return r.silenceUncaughtInPromise(w), r.extend(w, { transition: y });
	      }, t.prototype.is = function (t, e, n) {
	        n = r.defaults(n, { relative: this.$current });var o = this.router.stateRegistry.matcher.find(t, n.relative);if (i.isDefined(o)) return this.$current !== o ? !1 : i.isDefined(e) && null !== e ? p.Param.equals(o.parameters(), this.params, e) : !0;
	    ...
	    var r = n(45),
	        ...
	        a = function () {
	      function t(t) {
	        var e = this;this.params = new r.StateParams(), this.transitionHistory = new i.Queue([], 1), this.successfulTransitions = new i.Queue([], 1);var n = function n(t) {
	          e.transition = t, e.transitionHistory.enqueue(t);var n = function n() {
	            e.successfulTransitions.enqueue(t), e.$current = t.$to(), e.current = e.$current.self, o.copy(t.params(), e.params);
	          };t.onSuccess({}, n, { priority: 1e4 });var r = function r() {
	    ...
	    var r = n(3),
	      ...
	      function t(t) {
	        ...
	        var i,
	            ...
	            a = {},
	            u = [];for (var s in o) {
	          if (o[s] && o[s].params && (i = Object.keys(o[s].params), i.length)) for (var c in i) {
	            u.indexOf(i[c]) >= 0 || (u.push(i[c]), a[i[c]] = this[i[c]]);
	          }
	        }return r.extend({}, a, t);
	      }, t;
	    }();e.StateParams = i;
	    ...
	    function r(t) {
	      ...
	      }$ = new f.UIRouter(), $.stateRegistry.decorator("views", g.ng1ViewsBuilder), $.stateRegistry.decorator("onExit", w.getStateHookBuilder("onExit")), $.stateRegistry.decorator("onRetain", w.getStateHookBuilder("onRetain")), $.stateRegistry.decorator("onEnter", w.getStateHookBuilder("onEnter")), $.viewService.viewConfigFactory("ng1", g.ng1ViewConfigFactory), p.bindFunctions(t, l.services.locationConfig, t, ["hashPrefix"]);var n = [];l.services.location.onChange = function (t) {
	      ...
	      t.$watch(function () {
	        ...
	        y = n(56),
	        w = n(57),
	        b = angular.module("ui.router.angular1", []);angular.module("ui.router.util", ["ng", "ui.router.init"]), angular.module("ui.router.router", ["ui.router.util"]), angular.module("ui.router.state", ["ui.router.router", "ui.router.util", "ui.router.angular1"]), angular.module("ui.router", ["ui.router.init", "ui.router.state", "ui.router.angular1"]), angular.module("ui.router.compat", ["ui.router"]), e.annotateController = r, i.$inject = ["$injector", "$q"], b.run(i);var $ = null;o.$inject = ["$locationProvider"], angular.module("ui.router.init", []).provider("ng1UIRouter", o), angular.module("ui.router.init").run(["ng1UIRouter", function (t) {}]), angular.module("ui.router.util").provider("$urlMatcherFactory", ["ng1UIRouterProvider", function () {
	      return $.urlMatcherFactory;
	    }]), angular.module("ui.router.util").run(["$urlMatcherFactory", function (t) {}]), angular.module("ui.router.router").provider("$urlRouter", ["ng1UIRouterProvider", a]), angular.module("ui.router.router").run(["$urlRouter", function (t) {}]), angular.module("ui.router.state").provider("$state", ["ng1UIRouterProvider", u]), angular.module("ui.router.state").run(["$state", function (t) {}]), angular.module("ui.router.state").factory("$stateParams", ["ng1UIRouter", function (t) {
	    ...
	    var r = n(42),
	        ...
	        a = n(3),
	        u = n(40),
	        s = { resolve: function resolve(t, e, n) {
	        void 0 === e && (e = {});var s = new i.PathNode(new r.State({ params: {}, resolvables: [] })),
	            c = new i.PathNode(new r.State({ params: {}, resolvables: [] })),
	            f = new o.ResolveContext([s, c]);f.addResolvables(u.resolvablesBuilder({ resolve: t }), c.state);var l = function l(t) {
	          var n = function n(t) {
	            return u.resolvablesBuilder({ resolve: a.map(t, function (t) {
	                return function () {
	                  return t;
	                };
	              }) });
	          };f.addResolvables(n(t), s.state), f.addResolvables(n(e), c.state);var r = function r(t, e) {
	    ...
	    function r(t) {
	      var e = ["templateProvider", "templateUrl", "template", "notify", "async"],
	          ...
	          r = ["component", "bindings"],
	          c = e.concat(n),
	          f = r.concat(c),
	          l = {},
	          p = t.views || { $default: o.pick(t, f) };return o.forEach(p, function (e, n) {
	        if (n = n || "$default", s.isString(e) && (e = { component: e }), Object.keys(e).length) {
	          if (e.component) {
	            if (c.map(function (t) {
	              return s.isDefined(e[t]);
	            }).reduce(o.anyTrueR, !1)) throw new Error("Cannot combine: " + r.join("|") + " with: " + c.join("|") + " in stateview: 'name@" + t.name + "'");e.templateProvider = ["$injector", function (t) {
	              var n = function n(t) {
	                return e.bindings && e.bindings[t] || t;
	              },
	                  r = angular.version.minor >= 3 ? "::" : "",
	                  o = function o(t) {
	                var e = a.kebobString(t.name),
	                    i = n(t.name);return "@" === t.type ? e + "='{{" + r + "$resolve." + i + "}}'" : e + "='" + r + "$resolve." + i + "'";
	              },
	                  u = i(t, e.component).map(o).join(" "),
	                  s = a.kebobString(e.component);return "<" + s + " " + u + "></" + s + ">";
	            }];
	          }e.resolveAs = e.resolveAs || "$resolve", e.$type = "ng1", e.$context = t, e.$name = n;var f = u.ViewService.normalizeUIViewTarget(e.$context, e.$name);e.$uiViewName = f.uiViewName, e.$uiViewContextAnchor = f.uiViewContextAnchor, l[n] = e;
	        }
	      }), l;
	    }function i(t, e) {
	      var n = t.get(e + "Directive");if (!n || !n.length) throw new Error("Unable to find component named '" + e + "'");return n.map(v).reduce(o.unnestR, []);
	    }var o = n(3),
	        a = n(9),
	        u = n(37),
	        s = n(4),
	        ...
	        l = n(56),
	        p = n(17),
	        h = n(19);e.ng1ViewConfigFactory = function (t, e) {
	      return new g(t, e);
	    }, e.ng1ViewsBuilder = r;var d = function d(t) {
	      return Object.keys(t || {}).map(function (e) {
	        return [e, /^([=<@])[?]?(.*)/.exec(t[e])];
	      }).filter(function (t) {
	      ...
	      function t(t, e) {
	        ...
	        var t = this,
	            e = c.services.$q;if (!this.hasTemplate()) throw new Error("No template configuration specified for '" + this.viewDecl.$uiViewName + "@" + this.viewDecl.$uiViewContextAnchor + "'");var n = new p.ResolveContext(this.path),
	            r = this.path.reduce(function (t, e) {
	          return o.extend(t, e.paramValues);
	        }, {}),
	            i = { template: e.when(this.getTemplate(r, new l.TemplateFactory(), n)), controller: e.when(this.getController(n)) };return e.all(i).then(function (e) {
	        ...
	        var e = this.viewDecl.controllerProvider;if (!s.isInjectable(e)) return this.viewDecl.controller;var n = c.services.$injector.annotate(e),
	            r = s.isArray(e) ? o.tail(e) : e,
	            i = new h.Resolvable("", r, n);return i.get(t);
	      }, t;
	    }();e.Ng1ViewConfig = g;
	  }, function (t, e, n) {
	    "use strict";
	    var r = n(4),
	        ...
	        a = n(19),
	        u = function () {
	      function t() {}return t.prototype.fromConfig = function (t, e, n) {
	        ...
	        var u = i.services.$injector.annotate(t),
	            s = r.isArray(t) ? o.tail(t) : t,
	            c = new a.Resolvable("", s, u);return c.get(n);
	      }, t;
	    }();e.TemplateFactory = u;
	  }, function (t, e, n) {
	    "use strict";
	    var r = n(6),
	        i = n(53),
	        o = n(17),
	        a = n(3);e.getStateHookBuilder = function (t) {
	      return function (e, n) {
	        function u(t, e) {
	          var n = new o.ResolveContext(t.treeChanges().to);return r.services.$injector.invoke(s, this, a.extend({ $state$: e }, i.getLocals(n)));
	    ...
	    function r(t, e) {
	      var n,
	          r = t.match(/^\s*({[^}]*})\s*$/);if (r && (t = e + "(" + r[1] + ")"), n = t.replace(/\n/g, " ").match(/^([^(]+?)\s*(\((.*)\))?$/), !n || 4 !== n.length) throw new Error("Invalid state ref '" + t + "'");return { state: n[1], paramExpr: n[3] || null };
	    }function i(t) {
	      var e = t.parent().inheritedData("$uiView"),
	          n = f.parse("$cfg.path")(e);return n ? s.tail(n).state.name : void 0;
	    }function o(t) {
	      ...
	      return function (o) {
	        var a = o.which || o.button,
	          ...
	          });o.preventDefault();var c = r.isAnchor && !u.href ? 1 : 0;o.preventDefault = function () {
	            c-- <= 0 && n.cancel(s);
	          };
	        }
	      };
	      ...
	      return { restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function link(n, i, c, f) {
	          var l = r(c.uiSref, t.current.name),
	              p = { state: l.state, href: null, params: null, options: null },
	              h = o(i),
	              d = f[1] || f[0],
	              v = null;p.options = s.extend(u(i, t), c.uiSrefOpts ? n.$eval(c.uiSrefOpts) : {});var m = function m(e) {
	      ...
	      return { restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function link(n, r, i, u) {
	          function s(e) {
	            ...
	            return t || "null";
	              ...
	              h = { state: null, params: null, options: null, href: null },
	              d = null;n.$watch(p, s, !0), s(n.$eval(p)), c.clickable && r.bind("click", a(r, t, e, c, function () {
	            return h;
	          }));
	        } };
	    }],
	        h = ["$state", "$stateParams", "$interpolate", "$transitions", function (t, e, n, o) {
	      return { restrict: "A", controller: ["$scope", "$element", "$attrs", "$timeout", function (e, a, u, f) {
	          function l(e, n, r) {
	            var o = t.get(e, i(a)),
	                u = p(e, n),
	                s = { state: o || { name: e }, params: n, hash: u };return b.push(s), $[u] = r, function () {
	              var t = b.indexOf(s);-1 !== t && b.splice(t, 1);
	            };
	          }function p(t, n) {
	            if (!c.isString(t)) throw new Error("state should be a string");return c.isObject(n) ? t + s.toJson(n) : (n = e.$eval(n), c.isObject(n) ? t + s.toJson(n) : t);
	          }function h() {
	            for (var t = 0; t < b.length; t++) {
	              m(b[t].state, b[t].params) ? d(a, $[b[t].hash]) : v(a, $[b[t].hash]), g(b[t].state, b[t].params) ? d(a, y) : v(a, y);
	            }
	          }function d(t, e) {
	            f(function () {
	              t.addClass(e);
	            ...
	            return t.is(e.name, n);
	              ...
	              w,
	              b = [],
	              $ = {};y = n(u.uiSrefActiveEq || "", !1)(e);try {
	            w = e.$eval(u.uiSrefActive);
	          } catch (S) {}w = w || n(u.uiSrefActive || "", !1)(e), c.isObject(w) && s.forEach(w, function (n, i) {
	            if (c.isString(n)) {
	              var o = r(n, t.current.name);l(o.state, e.$eval(o.paramExpr), i);
	            }
	          }), this.$$addStateInfo = function (t, e) {
	            if (!(c.isObject(w) && b.length > 0)) {
	              var n = l(t, e, w);return h(), n;
	            }
	    ...
	    function r(t, e, n, r, s) {
	      var h = c.parse("viewDecl.controllerAs"),
	          d = c.parse("viewDecl.resolveAs");return { restrict: "ECA", priority: -400, compile: function compile(r) {
	          var s = r.html();return function (r, c) {
	            var v = c.data("$uiView");if (v) {
	              var m = v.$cfg || { viewDecl: {} };c.html(m.template || s), u.trace.traceUIViewFill(v.$uiView, c.html());var g = t(c.contents()),
	                  ...
	                  w = h(m),
	                  b = d(m),
	                  $ = m.path && new f.ResolveContext(m.path),
	                  S = $ && p.getLocals($);if (r[b] = S, y) {
	                var R = e(y, o.extend({}, S, { $scope: r, $element: c }));w && (r[w] = R, r[w][b] = S), c.data("$ngControllerController", R), c.children().data("$ngControllerController", R), i(n, R, r, m);
	      ...
	      !a.isFunction(e.$onInit) || r.viewDecl.component && d || e.$onInit();var i = o.tail(r.path).state.self,
	          u = { bind: e };if (a.isFunction(e.uiOnParamsChanged)) {
	        var s = new f.ResolveContext(r.path),
	          ...
	          if (t !== c && -1 === t.exiting().indexOf(i)) {
	            var n = t.params("to"),
	              ...
	              var e = u.indexOf(t);return -1 === e || !u[e].type.equals(n[t.id], r[t.id]);
	            });if (s.length) {
	        ...
	        var p = { exiting: i.name };n.$on("$destroy", t.onBefore(p, e.uiCanExit, u));
	      }
	    }var o = n(3),
	        a = n(4),
	        u = n(12),
	        ...
	        l = n(9),
	        p = n(53),
	        h = ["$view", "$animate", "$uiViewScroll", "$interpolate", "$q", function (t, e, n, r, i) {
	      function o(t, n) {
	        ...
	        return t === e;
	          ...
	          p = { count: 0, restrict: "ECA", terminal: !0, priority: 400, transclude: "element", compile: function compile(e, h, d) {
	          return function (e, h, v) {
	            function m(t) {
	              ...
	              if (w && (u.trace.traceUIViewEvent("Removing (previous) el", w.data("$uiView")), w.remove(), w = null), $ && (u.trace.traceUIViewEvent("Destroying scope", _), $.$destroy(), $ = null), b) {
	                var t = b.data("$uiView");u.trace.traceUIViewEvent("Animate out", t), x.leave(b, function () {
	                  t.$$animLeave.resolve(), w = null;
	                }), w = b, b = null;
	              }
	            }function y(t) {
	              var r = e.$new();u.trace.traceUIViewScopeCreated(_, r);var o = i.defer(),
	                  s = i.defer(),
	                  c = { $cfg: t, $uiView: _, $animEnter: o.promise, $animLeave: s.promise, $$animLeave: s },
	                  f = d(r, function (t) {
	                ...
	                x = o(v, e),
	                P = void 0,
	                k = h.inheritedData("$uiView") || l,
	                C = r(v.uiView || v.name || "")(e) || "$default",
	                _ = { $type: "ng1", id: p.count++, name: C, fqn: k.$uiView.fqn ? k.$uiView.fqn + "." + C : C, config: null, configUpdated: m, get creationContext() {
	    ...
	    }];r.$inject = ["$compile", "$controller", "$transitions", "$view", "$timeout"];var d = "function" == typeof angular.module("ui.router").component;angular.module("ui.router.state").directive("uiView", h), angular.module("ui.router.state").directive("uiView", r);
	  }, function (t, e) {
	    "use strict";
	    function n() {
